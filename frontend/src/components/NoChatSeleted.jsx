...
const NoChatSelected = () => {
    return (
        <div className="flex-1 h-screen flex items-center justify-center bg-base-200">
            <div className="max-w-md text-center space-y-6 px-6">
                ...
                <h2 className="text-4xl font-extrabold text-base-content tracking-wide">No Chat Selected</h2>
