...
import { MessageCircle, User, LogOut, Palette, Settings } from 'lucide-react';
...
const Navbar = () => {
  ...
  return (
    <nav className="w-full px-4 sm:px-8 py-5 bg-base-100 shadow-md flex items-center justify-between border-b border-base-300">
      {/* Left: Chat Logo */}
      <div onClick={toggleSidebar} className="flex items-center gap-2 text-base-content hover:text-primary transition sm:hidden cursor-pointer z-50">
